...
const EDIT_VERBS = [
  ...
  'delete', 'remove', 'trim', 'split', 'move', 'retime', 'slip', 'roll', 'slide',
...
const ROUTING_GROUPS: readonly RoutingGroup[] = [
  {
    mutating: true,
    requestKeywords: [
      'trim', 'split', 'move clip', 'delete clip', 'remove clip', 'retime', 'slip edit', 'roll edit', 'roll the cut', 'slide edit', 'slide clip',
      ...
      'adjustment layer', 'grade everything', 'grade the whole', 'colour grade', 'color grade',
      '剪辑', '裁剪', '分割', '移动片段', '删除片段', '移除片段', '变速', '滑动编辑', '滚动编辑', '滚动剪辑点',
      '背景填充', '模糊背景', '虚化背景', '撤销', '重做', '调整图层', '整体调色',
      '重新开始', '全部删除', '全部清空', '关联组',
    ],
