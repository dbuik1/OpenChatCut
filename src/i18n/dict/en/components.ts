...
export default {
  ...
  '分量': 'RGB parade',
  '矢量': 'Vectorscope',
  '播放头停下时刷新': 'Refreshes when the playhead settles',
  '第 {n} 帧 · 播放头停下时刷新': 'Frame {n} · refreshes when the playhead settles',
  '正在渲染示波器…': 'Rendering scopes…',
  '示波器渲染失败：{error}': 'Scopes could not render: {error}',
  '特效': 'Effects',
  '画布': 'Canvas',
  ...
  '分析中…': 'Analyzing…',
  '测量并归一到 {target} LUFS': 'Measure and normalize to {target} LUFS',
  '响度归一 ({target} LUFS)': 'Normalize loudness ({target} LUFS)',
  '测量中…': 'Measuring…',
  '已归一 {n} 个片段，音量见上方': 'Normalized {n} clip(s) — volume is above',
  '响度目标': 'Loudness target',
  '-14 流媒体': '-14 streaming',
  '-16 播客': '-16 podcast',
  '-23 广播': '-23 broadcast',
